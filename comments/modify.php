<div id="modifyPage">
    ...
    <div class="col-sm-12" id="commentInfo">
        ...
        <div class="col-sm-7" id="commentTitle" onclick="openCommentList();"
             style="cursor: pointer; color: white; font-size: 1.3vw; text-align: center; margin-left: 20px" data-toggle="tooltip" title="Click to view the comment" data-toggle="tooltip" data-placement="top" href="javascript:void(0)" onmouseover="tootips();"></div>
