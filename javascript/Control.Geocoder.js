...
module.exports = {
	"class": L.Class.extend({
		options: {
			serviceUrl: 'http://hub.geosmartcity.eu/opentripplanner/otp/routers/default/geocode',
			reverseUrl: 'http://hub.geosmartcity.eu/opentripplanner/otp/routers/default/plan',
			nameProperties: [
				'name',
				'street',
				'suburb',
		...
		_decodeFeatures: function(data) {
			...
			var results = [],
				...
				for (i = 0; i < data.length; i++) {
					...
					latLng = L.latLng(data[i].lat, data[i].lng);
	...
	factory: function(options) {
		return new L.Control.Geocoder.OpenTripPlaner(options);
	}
};
...
var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
	...
	OpenTripPlaner = require('./geocoders/opentripplaner');
...
module.exports = L.Util.extend(Control["class"], {
	...
	OpenTripPlaner: OpenTripPlaner["class"],
	opentripplaner: OpenTripPlaner.factory
});
...
},{"./control":1,"./geocoders/bing":2,"./geocoders/google":3,"./geocoders/mapbox":4,"./geocoders/mapquest":5,"./geocoders/mapzen":6,"./geocoders/nominatim":7,"./geocoders/photon":8,'./geocoders/opentripplaner':9, "./geocoders/what3words":10}],12:[function(require,module,exports){
(function (global){
var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
	lastCallbackId = 0,
	htmlEscape = (function() {
