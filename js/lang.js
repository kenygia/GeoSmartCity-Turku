...
/**
 * Function called from index.php when info icon is clicked.
...
function infoPage(){
	...
	if(lang === "fi")
		window.location = window.location.href +"gsc_info/?page=home&lang=fi";
	if(lang === "en")
		window.location = window.location.href +"gsc_info/?page=home&lang=en";
	if(lang === "sv")
		window.location = window.location.href +"gsc_info/?page=home&lang=sw";
}
...
var lang = {
        ...
        'SETTINGS': 'Asetukset',
        'CO2': 'CO2 päästö (g): ',
        'OFFSET': 'Luontovaikutus(puut/päivä): ',
        'APPLY': 'Ok',
    ...
    en: {
        ...
        'SETTINGS': 'Settings',
        'CO2': 'CO2 emission (g): ',
        'OFFSET': 'Nature effect (trees/day): ',
        'APPLY': 'Apply',
        'CHANGE': 'Change route'
